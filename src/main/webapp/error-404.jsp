<%-- NOTA ALIRAN KOD: Fail error-404.jsp. Halaman ini biasa dipanggil terus melalui UI atau navigation ke /error-404.jsp. Tujuan nota ni supaya orang seterusnya terus nampak konteks fail ni. --%>
...
<head>
    ...
    <title>404 â€“ Halaman Tidak Dijumpai | SPPA</title>
    <style>
        ...
        * { box-sizing: border-box; }
        ...
        .card { background: white; border-radius: 20px; padding: 48px 52px; text-align: center;
                max-width: 500px; width: 90%; box-shadow: 0 24px 60px rgba(8,51,77,0.25); }
        .code { font-size: 96px; font-weight: 800; color: var(--brand-blue); line-height: 1;
...
<div class="card">
    ...
    <p class="desc">Maaf, halaman yang anda cari tidak wujud atau telah dialihkan ke alamat lain.</p>
    <a href="${pageContext.request.contextPath}/login" class="btn btn-primary">Halaman Utama</a>
    <a href="javascript:history.back()" class="btn btn-secondary">Kembali</a>
    <hr class="divider">
    <p class="hint">Sistem Pendaftaran Pembekal dan Produk Bekalan Air (SPPA) &mdash; Jabatan Air Sabah</p>
</div>
</body>
</html>
