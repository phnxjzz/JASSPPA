<%-- NOTA ALIRAN KOD: Fail error.500.jsp. Halaman ini biasa dipanggil terus melalui UI atau navigation ke /error.500.jsp. Tujuan nota ni supaya orang seterusnya terus nampak konteks fail ni. --%>
...
<head>
    ...
    <title>500 â€“ Ralat Pelayan | SPPA</title>
    <style>
