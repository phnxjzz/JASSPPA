                ...
                <div class="feature-page">
                    <div class="feature-card" style="--card-bg: url('${pageContext.request.contextPath}/assets/images/application.webp')">
                        ...
                        <div class="feature-actions">
                            ...
                            <a class="cta cta-secondary" href="#" id="openRenewalListBtn">Borang Pembaharuan</a>
                        </div>
                    </div>
                </div>
    ...
    <div class="app-panel" role="dialog" aria-modal="true" aria-label="Senarai Permohonan">
        ...
        <% } else { %>
            <table class="app-table">
                ...
                <%  for (java.util.Map<String, Object> app : userApplications) {
                        String appStatus = app.get("status") == null ? "" : String.valueOf(app.get("status"));
                        String appType = app.get("application_type") == null ? "" : String.valueOf(app.get("application_type"));
                        boolean isRenewal = "PEMBAHARUAN".equalsIgnoreCase(appType);
                %>
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="${pageContext.request.contextPath}/renewal-form?id=<%= app.get("id") %>" style="color:#0f766e;font-weight:700;text-decoration:none;">Borang KSPP</a>
                            <span style="color:#94a3b8;"> | </span>
                            <a href="${pageContext.request.contextPath}/renewal-form/pdf?id=<%= app.get("id") %>" style="color:#d97706;font-weight:700;text-decoration:none;">PDF KSPP</a>
                            <% } %>
                        </td>
                    </tr>
                <%  } %>
...
<div class="app-modal" id="renewalListModal" aria-hidden="true">
    <div class="app-panel" role="dialog" aria-modal="true" aria-label="Senarai Borang Pembaharuan">
        <div class="app-panel-head">
            <h4>Senarai Permohonan Diluluskan Untuk Pembaharuan</h4>
            <button class="notif-close" type="button" id="renewalListClose" aria-label="Tutup">x</button>
        </div>
        <%
            boolean hasApprovedApplications = false;
            if (userApplications != null) {
                for (java.util.Map<String, Object> app : userApplications) {
                    String appStatus = app.get("status") == null ? "" : String.valueOf(app.get("status"));
                    if ("APPROVED".equalsIgnoreCase(appStatus)) {
                        hasApprovedApplications = true;
                        break;
                    }
                }
            }
        ...
        %>
            <div class="notif-item">Tiada permohonan yang telah diluluskan untuk pembaharuan.</div>
        <% } else { %>
            <table class="app-table">
                <thead>
                    <tr>
                ...
                %>
                    <tr>
                        ...
                        <td><%= app.get("submitted_at") == null ? "-" : app.get("submitted_at") %></td>
                        <td>
                            <a href="${pageContext.request.contextPath}/applications/new?renewFrom=<%= app.get("id") %>" style="color:#0f766e;font-weight:700;text-decoration:none;">PEMBAHARUAN</a>
                            <span style="color:#94a3b8;"> | </span>
                            <a href="${pageContext.request.contextPath}/applications/<%= app.get("id") %>" style="color:#0d6fa7;font-weight:700;text-decoration:none;">Lihat</a>
                        </td>
                    </tr>
...
<script>
    (function () {
        ...
        var closeRenewalList = makeModalHandlers('renewalListModal', 'renewalListClose', 'openRenewalListBtn');
